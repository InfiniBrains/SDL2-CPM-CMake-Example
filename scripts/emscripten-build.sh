...
source ${DIRECTORY}/emscripten-install.sh
...
emcmake cmake -DCMAKE_C_ABI_COMPILED=ON -DCMAKE_CXX_ABI_COMPILED=ON -DCMAKE_BUILD_TYPE=MinSizeRel -H. -Bbin-emscripten
